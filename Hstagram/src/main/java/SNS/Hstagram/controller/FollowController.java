...
public class FollowController {
    ...
    public ResponseEntity<String> followUser(@RequestParam Long followerId, @PathVariable Long followingId) {
    ...
    public ResponseEntity<String> unfollowUser(@RequestParam Long followerId, @PathVariable Long followingId) {
